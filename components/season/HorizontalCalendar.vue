          ...
          <div class="flex justify-between h-full items-center">
            <div v-for="round in stage.rounds" :key="round.id" class="flex flex-col items-center p-2">
              <NuxtLink
                ...
                class="size-6 rounded-full text-white text-xs font-bold cursor-pointer transition-opacity duration-200 flex items-center justify-center hover:opacity-80"
