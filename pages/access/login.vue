  ...
  <main class="space-y-8">
    ...
    <form @submit.prevent="handleLogin" class="max-w-md mx-auto space-y-4" ref="formRef" autocomplete="off">
      ...
      <div class="space-y-2">
        ...
        <input id="password" name="password" type="password" autocomplete="new-password" required class="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
      </div>
